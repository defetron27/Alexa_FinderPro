...
public class ThisIsNotMyFileNameIntentRequestHandler implements RequestHandler
{
    @Override
    public boolean canHandle(HandlerInput input)
    {
        return input.matches(intentName("ThisIsNotMyFileNameIntent"));
    }
                    ...
                    if (intentName != null)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                String title = "say file name again";

                                String message = "Okay don't worry please say the file name again with the keyword file name. " +
