...
public class ThisIsMyTargetFileNameIntentRequestHandler implements RequestHandler
{
    @Override
    public boolean canHandle(HandlerInput input)
    {
        return input.matches(intentName("ThisIsMyTargetFileNameIntent"));
    }
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                String title = "say target file format";

                                                String message = "Okay, now say the target file format of your target file with the keyword target file format. Example, target file format jpg.";
