...
public class ThisIsNotMyBucketNameIntentRequestHandler implements RequestHandler
{
    @Override
    public boolean canHandle(HandlerInput input)
    {
        return input.matches(intentName("ThisIsNotMyBucketNameIntent"));
    }
                ...
                if (intent != null)
                {
                    ...
                    if (intentName != null)
                    {
                        ...
                        else
                        {
                            ...
                            String message = "Okay don't worry please say the bucket name again with the keyword bucket name. " +
