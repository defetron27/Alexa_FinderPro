...
public class ThisIsNotMyFileFormatIntentRequestHandler implements RequestHandler
{
    @Override
    public boolean canHandle(HandlerInput input)
    {
        return input.matches(intentName("ThisIsNotMyFileFormatIntent"));
    }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    String title = "say file format again";

                                    String message = "Okay don't worry please say the file format again with the keyword file format. " +
