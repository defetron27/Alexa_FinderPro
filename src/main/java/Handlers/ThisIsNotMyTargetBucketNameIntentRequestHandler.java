...
public class ThisIsNotMyTargetBucketNameIntentRequestHandler implements RequestHandler
{
    @Override
    public boolean canHandle(HandlerInput input)
    {
        return input.matches(intentName("ThisIsNotMyTargetBucketNameIntent"));
    }
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        String message = "Okay don't worry please say the target bucket name again with the keyword target bucket name. " +
                                                "Example, target bucket name solver. ";
