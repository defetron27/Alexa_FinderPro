...
public class ThisIsNotMyTargetFileFormatIntentRequestHandler implements RequestHandler
{
    @Override
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                String title = "say target file format again";

                                                String message = "Okay don't worry please say the target file format again with the keyword target file format. " +
