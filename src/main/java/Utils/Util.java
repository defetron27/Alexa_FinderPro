...
public class Util
{
    ...
    public static Optional<Response> getSimpleResponse(HandlerInput input, String title, String message, String screenMessage, String prompt, Map<String,Object> session)
    {
        AttributesManager attributesManager = input.getAttributesManager();

        Map<String, Object> document = getDirectivesResponse("file","simpleWithHeader.json");

        Map<String, Object> dataSource = getDirectivesResponse("class",JsonHelper.convertSimpleWithHeader(title,screenMessage));
